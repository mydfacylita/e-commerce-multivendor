...
async function main() {
  ...
  try {
    ...
    console.log('Token (primeiros 30 chars):', gateway.config.accessToken?.substring(0, 30) + '...')
    
    const token = gateway.config.accessToken
    ...
    console.log('Status pagamento:', paymentRes.status)
