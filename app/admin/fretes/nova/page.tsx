...
export default function NovaRegraFrete() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage = errorData.details || errorData.error || errorData.message || 'Erro ao criar regra'
      ...
      setError(err.message || 'Erro desconhecido ao criar regra')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Nova Regra de Frete</h1>
          <p className="text-gray-600 mt-2">Crie uma nova regra de cálculo de frete</p>
        </div>
        <Link
          href="/admin/fretes"
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <label htmlFor="isActive" className="text-sm font-medium text-gray-700">
            Regra ativa (começar a usar imediatamente)
          </label>
        </div>
