  ...
  try {
    ...
    return NextResponse.json({
      config: {
        ...
        percentualExtra: parseFloat(configMap['percentualExtra'] || '2'),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const keysToSave = [
      ...
      { key: 'correios.codigoAcesso', value: config.codigoAcesso || '', label: 'Código de Acesso API' },
      ...
      { key: 'correios.percentualExtra', value: String(config.percentualExtra || 2), label: 'Percentual Extra Frete' },
