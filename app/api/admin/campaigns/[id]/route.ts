  ...
  try {
    ...
    const campaign = await prisma.affiliateCampaign.update({
      ...
      data: {
        ...
        ...(data.reelsCount !== undefined && { reelsCount: data.reelsCount ?? 0 }),
        ...(data.postsCount !== undefined && { postsCount: data.postsCount ?? 0 }),
        ...(data.storiesCount !== undefined && { storiesCount: data.storiesCount ?? 0 }),
