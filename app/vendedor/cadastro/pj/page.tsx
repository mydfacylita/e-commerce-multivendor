...
export default function SellerSignupPJPage() {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-600 mb-8">Pessoa Jurídica</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full border rounded-lg px-4 py-2"
                    placeholder="Conte sobre sua empresa, produtos que vende, diferenciais..."
                  />
                </div>
              </div>
            </div>
            ...
            {/* Dados da Empresa */}
            <div>
              <h2 className="text-xl font-semibold mb-4 text-gray-900">Dados da Empresa</h2>
            ...
            {/* Endereço */}
            <div>
              <h2 className="text-xl font-semibold mb-4 text-gray-900">Endereço Comercial</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
            ...
            {/* Dados Bancários */}
            <div>
              <h2 className="text-xl font-semibold mb-4 text-gray-900">Dados Bancários da Empresa</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium mb-2">Chave PIX (CNPJ)</label>
                  <input
                    type="text"
                    name="chavePix"
                    ...
                    onChange={handleChange}
                    className="w-full border rounded-lg px-4 py-2"
                    placeholder="CNPJ, e-mail corporativo ou chave aleatória"
                  />
                </div>
              </div>
            </div>
