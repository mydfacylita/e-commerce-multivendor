...
import { FiMessageSquare, FiSend, FiCheck, FiClock, FiChevronDown, FiChevronUp, FiPackage } from 'react-icons/fi'
...
export default function VendedorPerguntasPage() {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Responda as dúvidas dos clientes sobre seus produtos
          </p>
        </div>
      </div>
